...
public class listAdaptor extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(weatherItemObj!=null){
            ...
            ImageView weatherIcon = (ImageView) convertView.findViewById(R.id.imageViewWeatherStatus);
            String uri = "drawable/i" + weatherItemObj.getIcon();

            int iconResource = context.getResources().getIdentifier(uri, "drawable", MainActivity.PACKAGE_NAME);
